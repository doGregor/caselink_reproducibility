...
parser.add_argument("--ngram_1", type=int, default=4, help="ngram")
parser.add_argument("--ngram_2", type=int, default=4, help="ngram")
parser.add_argument("--topk", type=int, default=5, help="select top-k cases as final prediction")
...
WDIR = path + '/datasets/' + args.dataset + '/bm25_separate'
...
pred_df.to_csv(path + '/datasets/' + args.dataset + '/bm25_separate/' + args.data_split + '_ngarm(' + str(args.ngram_1) + str(args.ngram_2) + ').csv')
## bm25 computing ends

## Evaluation starts
print('ngram:', str(args.ngram_1), str(args.ngram_2))
file_path = path + '/datasets/' + args.dataset + '/bm25_separate/' + args.data_split + '_ngarm(' + str(args.ngram_1) + str(args.ngram_2) + ').csv'
