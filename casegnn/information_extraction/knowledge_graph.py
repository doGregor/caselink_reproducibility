...
if args.feature == "fact":
    if args.llm == "gpt":
        ...
        input_path = path + '/datasets/' + args.dataset + '/' + args.data_split + '_summary_txt_llama'
        output_path = path + '/datasets/' + args.dataset + '/information_extraction/' + args.data_split + '_summary_llama'
    else:
