...
def forward(dataset, model, device, writer, dataloader, data, label_dict, train_candidate_list, yf_path, epoch, batch_size, temp, lamb, hard_neg_num, train_flag, test_mask, test_label_list, test_query_list, test_query_index_list, prediction_saving, optimizer=None,  training_setup='tmp'):
    if train_flag:
        ## Training
        model.train()
        print('epoch: ', epoch)
